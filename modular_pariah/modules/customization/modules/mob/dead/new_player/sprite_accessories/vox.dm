...
/datum/sprite_accessory/snouts/vox
	icon = 'modular_pariah/master_files/icons/mob/sprite_accessory/vox_snouts.dmi'
...
/datum/sprite_accessory/hair/vox
	icon = 'modular_pariah/master_files/icons/mob/sprite_accessory/vox_hair.dmi'
	recommended_species = list(SPECIES_VOX)
...
/datum/sprite_accessory/facial_hair/vox
	icon = 'modular_pariah/master_files/icons/mob/sprite_accessory/vox_facial_hair.dmi'
	recommended_species = list(SPECIES_VOX)
...
/datum/sprite_accessory/tails/vox
	icon = 'modular_pariah/master_files/icons/mob/sprite_accessory/vox_tails.dmi'
	name = "Vox Tail"
	icon_state = "vox"
	recommended_species = list(SPECIES_VOX)
...
/datum/sprite_accessory/spines/vox
	icon = 'modular_pariah/master_files/icons/mob/sprite_accessory/vox_spines.dmi'
