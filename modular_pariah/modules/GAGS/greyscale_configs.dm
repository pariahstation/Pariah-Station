...
/datum/greyscale_config/beret_badge_fancy
	...
	json_config = 'modular_pariah/modules/GAGS/json_configs/beret/beret_badge_fancy.json'
...
/datum/greyscale_config/wraps
	name = "Cloth Wraps"
	icon_file = 'modular_pariah/modules/GAGS/icons/shoes.dmi'
	json_config = 'modular_pariah/modules/GAGS/json_configs/wraps/wraps.json'
