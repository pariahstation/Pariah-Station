...
/obj/machinery/door/airlock/multi_tile/glass
	...
	icon = 'modular_pariah/modules/large_doors/icons/glass/multi_tile.dmi'
	overlays_file = 'modular_pariah/modules/large_doors/icons/glass/overlays.dmi'
	opacity = FALSE
...
/obj/machinery/door/airlock/multi_tile/metal
	name = "Large Airlock"
	icon = 'modular_pariah/modules/large_doors/icons/metal/multi_tile.dmi'
	overlays_file = 'modular_pariah/modules/large_doors/icons/metal/overlays.dmi'
...
/obj/airlock_filler_object
	...
	opacity = TRUE
	anchored = TRUE
	atmos_canpass = ATMOS_PASS_DENSITY
	var/parent_airlock
