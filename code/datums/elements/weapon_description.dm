...
/datum/element/weapon_description
	...
	var/list/victims = list("a human", "a gamuioda", "a felinid", "a unathi", "a particularly resilient slime", "a syndicate agent", "a clown", "a mime", "a mortal foe", "an innocent bystander")
