...
/datum/symptom/fire/proc/Firestacks_stage_4(mob/living/M, datum/disease/advance/A)
	...
	M.take_overall_damage(burn = 3 * power, required_status = BODYTYPE_ORGANIC) //PARIAH MODULAR EDIT
	if(infective)
		A.spread(2)
	return 1
...
/datum/symptom/fire/proc/Firestacks_stage_5(mob/living/M, datum/disease/advance/A)
	...
	M.take_overall_damage(burn = 5 * power, required_status = BODYTYPE_ORGANIC) //PARIAH MODULAR EDIT
	if(infective)
		A.spread(4)
	return 1
...
/datum/symptom/alkali/proc/Alkali_fire_stage_4(mob/living/M, datum/disease/advance/A)
	...
	M.take_overall_damage(burn = get_stacks / 2, required_status = BODYTYPE_ORGANIC) //PARIAH MODULAR EDIT
	if(chems)
...
/datum/symptom/alkali/proc/Alkali_fire_stage_5(mob/living/M, datum/disease/advance/A)
	...
	M.adjust_fire_stacks(get_stacks)
	M.take_overall_damage(burn = get_stacks, required_status = BODYTYPE_ORGANIC) //PARIAH MODULAR EDIT
	if(chems)
