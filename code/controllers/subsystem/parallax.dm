...
/datum/controller/subsystem/parallax/PreInit()
	...
	if(prob(70)) //70% chance to pick a special extra layer
		random_layer = pick(/atom/movable/screen/parallax_layer/random/space_gas, /atom/movable/screen/parallax_layer/random/asteroids, /atom/movable/screen/parallax_layer/random/nebula)
