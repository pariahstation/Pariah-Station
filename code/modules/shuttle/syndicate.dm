...
/obj/machinery/computer/camera_advanced/shuttle_docker/syndicate
	...
	x_offset = -7
	y_offset = -1
	whitelist_turfs = list(/turf/space, /turf/simulated/open/floor/plating, /turf/simulated/open/lava, /turf/closed/mineral, /turf/simulated/open/openspace, /turf/simulated/open/misc)
	see_hidden = TRUE
