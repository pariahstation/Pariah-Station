...
/datum/map_generator/ca
	...
	var/width = 10
	var/height = 10
	var/list/type_map = list(/turf/simulated/open/floor/plating, /turf/closed/wall)
	var/turf/start = null
...
/datum/map_generator/ca/caves
	b_rule = list(5,6,7,8)
	s_rule = list(4)
	type_map = list(/turf/simulated/open/misc/asteroid/basalt, /turf/closed/mineral/volcanic)
	iterations = 5
