...
/obj/item/organ/zombie_infection/Remove(mob/living/carbon/M, special = 0)
	...
	if(iszombie(M) && old_species && !special) //PARIAH STATION EDIT
...
/obj/item/organ/zombie_infection/process(delta_time)
	...
	timer_id = addtimer(CALLBACK(src, .proc/zombify, owner), revive_time, flags) //PARIAH STATION EDIT

/obj/item/organ/zombie_infection/proc/zombify(var/mob/living/carbon/C) //PARIAH STATION EDIT
	timer_id = null
