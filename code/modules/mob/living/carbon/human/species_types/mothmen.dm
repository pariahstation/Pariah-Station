...
/datum/species/moth/get_species_lore()
	return list(
		...
		"Upon meeting other lifeforms outside of their planet, notably Humans, the Gamuoida would begin to offer their population as a labor force for stations, ships, and other facilities requiring employment. \
