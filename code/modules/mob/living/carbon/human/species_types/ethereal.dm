/datum/species/ethereal
	...
	species_traits = list(DYNCOLORS, AGENDER, NO_UNDERWEAR, HAIR, FACEHAIR, HAS_FLESH, HAS_BONE, BODY_RESIZABLE) // i mean i guess they have blood so they can have wounds too
