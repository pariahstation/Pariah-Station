...
/turf/simulated/open/misc/asteroid/drill_act(obj/item/mecha_parts/mecha_equipment/drill/drill)
	for(var/turf/simulated/open/misc/asteroid/M in range(1, drill.chassis))
