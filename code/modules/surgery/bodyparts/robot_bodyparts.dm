...
/obj/item/bodypart/l_arm/robot
	...
	limb_id = "robotic" //PARIAH STATION EDIT
	attack_verb_continuous = list("slaps", "punches")
	attack_verb_simple = list("slap", "punch")
	inhand_icon_state = "buildpipe"
	static_icon =  'icons/mob/augmentation/augments.dmi' //PARIAH STATION EDIT
	icon = null // PARIAH STATION EDIT
	flags_1 = CONDUCT_1
	icon_state = "borg_l_arm"
	is_dimorphic = FALSE //PARIAH STATION EDIT START
	should_draw_greyscale = FALSE
	bodytype = BODYTYPE_HUMANOID | BODYTYPE_ROBOTIC
	change_exempt_flags = BP_BLOCK_CHANGE_SPECIES //PARIAH STATION EDIT END
	disable_threshold = 1
