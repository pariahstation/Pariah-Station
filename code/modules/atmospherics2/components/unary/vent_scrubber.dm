/obj/machinery/atmospherics/unary/vent_scrubber
	...
	public_variables = list(
		...
		/datum/public_access/public_variable/scrubbing,
		/datum/public_access/public_variable/panic,
		/datum/public_access/public_variable/scrubbing_gas
	)
	public_methods = list(
		/datum/public_access/public_method/toggle_power,
		/datum/public_access/public_method/refresh,
		/datum/public_access/public_method/toggle_panic_siphon,
		/datum/public_access/public_method/set_scrub_gas
	)
	stock_part_presets = list(
		/datum/stock_part_preset/radio/receiver/vent_scrubber = 1,
		/datum/stock_part_preset/radio/event_transmitter/vent_scrubber = 1
	)
...
/obj/machinery/atmospherics/unary/vent_scrubber/proc/toggle_panic()
	var/datum/public_access/public_variable/panic/panic = decls_repository.get_decl(/datum/public_access/public_variable/panic)
...
/obj/machinery/atmospherics/unary/vent_scrubber/cannot_transition_to(state_path, mob/user)
	if(state_path == /datum/machine_construction/default/deconstructed)
...
/datum/public_access/public_variable/scrubbing/access_var(obj/machinery/atmospherics/unary/vent_scrubber/machine)
	return machine.scrubbing

/datum/public_access/public_variable/scrubbing/write_var(obj/machinery/atmospherics/unary/vent_scrubber/machine, new_value)
...
/datum/public_access/public_variable/panic/access_var(obj/machinery/atmospherics/unary/vent_scrubber/machine)
	return machine.panic

/datum/public_access/public_variable/panic/write_var(obj/machinery/atmospherics/unary/vent_scrubber/machine, new_value)
...
/datum/public_access/public_variable/scrubbing_gas/access_var(obj/machinery/atmospherics/unary/vent_scrubber/machine)
...
/datum/stock_part_preset/radio/event_transmitter/vent_scrubber
	frequency = PUMP_FREQ
	...
	transmit_on_event = list(
		...
		"panic" = /datum/public_access/public_variable/panic,
		"scrubbing" = /datum/public_access/public_variable/scrubbing,
		"scrubbing_gas" = /datum/public_access/public_variable/scrubbing_gas
	)

/datum/stock_part_preset/radio/receiver/vent_scrubber
	frequency = PUMP_FREQ
	filter = RADIO_FROM_AIRALARM
	receive_and_call = list(
		"power_toggle" = /datum/public_access/public_method/toggle_power,
		"toggle_panic_siphon" = /datum/public_access/public_method/toggle_panic_siphon,
		"set_scrub_gas" = /datum/public_access/public_method/set_scrub_gas,
	...
	receive_and_write = list(
		...
		"panic_siphon" = /datum/public_access/public_variable/panic,
		"set_scrubbing" = /datum/public_access/public_variable/scrubbing,
		"init" = /datum/public_access/public_variable/name
	)

/datum/stock_part_preset/radio/receiver/vent_scrubber/shuttle
	frequency = SHUTTLE_AIR_FREQ

/datum/stock_part_preset/radio/event_transmitter/vent_scrubber/shuttle
	frequency = SHUTTLE_AIR_FREQ
...
/obj/machinery/atmospherics/unary/vent_scrubber/on/shuttle_auxiliary
	stock_part_presets = list(
		/datum/stock_part_preset/radio/receiver/vent_scrubber/shuttle = 1,
		/datum/stock_part_preset/radio/event_transmitter/vent_scrubber/shuttle = 1
	)
