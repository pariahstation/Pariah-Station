...
/obj/machinery/atmospherics/binary/pump
	...
	public_variables = list(
		...
		/datum/public_access/public_variable/pump_target_output
	)
	public_methods = list(
	...
	stock_part_presets = list(
		/datum/stock_part_preset/radio/receiver/pump = 1,
		/datum/stock_part_preset/radio/event_transmitter/pump = 1
	)
...
/datum/public_access/public_variable/pump_target_output/access_var(obj/machinery/atmospherics/binary/pump/machine)
	return machine.target_pressure

/datum/public_access/public_variable/pump_target_output/write_var(obj/machinery/atmospherics/binary/pump/machine, new_value)
	new_value = clamp(new_value, 0, machine.max_pressure_setting)
	. = ..()
	if(.)
		machine.target_pressure = new_value

/datum/stock_part_preset/radio/event_transmitter/pump
	frequency = PUMP_FREQ
	...
	transmit_on_event = list(
		...
		"target_output" = /datum/public_access/public_variable/pump_target_output
	)

/datum/stock_part_preset/radio/receiver/pump
	frequency = PUMP_FREQ
	filter = RADIO_ATMOSIA
	...
	receive_and_write = list(
		...
		"set_output_pressure" = /datum/public_access/public_variable/pump_target_output
	)
