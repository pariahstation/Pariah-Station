...
/datum/public_access/public_variable/valve_open
...
/datum/public_access/public_variable/valve_open/access_var(obj/machinery/atmospherics/valve/valve)
	return valve.open

/datum/public_access/public_method/open_valve
	name = "open valve"
	desc = "Sets the valve to open."
	call_proc = /obj/machinery/atmospherics/valve/proc/open

/datum/public_access/public_method/close_valve
	name = "open valve"
	desc = "Sets the valve to open."
	call_proc = /obj/machinery/atmospherics/valve/proc/close

/datum/public_access/public_method/toggle_valve
	name = "toggle valve"
...
/obj/machinery/atmospherics/valve/digital		// can be controlled by AI
	...
	public_variables = list(/datum/public_access/public_variable/valve_open)
	public_methods = list(
		/datum/public_access/public_method/open_valve,
		/datum/public_access/public_method/close_valve,
		/datum/public_access/public_method/toggle_valve
	)
	stock_part_presets = list(/datum/stock_part_preset/radio/receiver/valve = 1)
...
/datum/stock_part_preset/radio/receiver/valve
	frequency = FUEL_FREQ
	filter = RADIO_ATMOSIA
	receive_and_call = list(
		"valve_open" = /datum/public_access/public_method/open_valve,
		"valve_close" = /datum/public_access/public_method/close_valve,
		"valve_toggle" = /datum/public_access/public_method/toggle_valve
	)
