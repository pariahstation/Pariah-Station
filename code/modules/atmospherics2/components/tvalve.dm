...
/datum/public_access/public_variable/tvalve_state
...
/datum/public_access/public_variable/tvalve_state/access_var(obj/machinery/atmospherics/tvalve/tvalve)
	return tvalve.state

/datum/public_access/public_method/tvalve_go_straight
...
/datum/public_access/public_method/tvalve_go_side
	name = "valve go side"
	desc = "Redirects output to the side."
	call_proc = /obj/machinery/atmospherics/tvalve/proc/go_to_side

/datum/public_access/public_method/tvalve_toggle
	name = "valve toggle"
	desc = "Toggles the output direction."
	call_proc = /obj/machinery/atmospherics/tvalve/proc/toggle

/datum/stock_part_preset/radio/receiver/tvalve
	frequency = FUEL_FREQ
	filter = RADIO_ATMOSIA
	receive_and_call = list(
		"valve_open" = /datum/public_access/public_method/tvalve_go_side,
		"valve_close" = /datum/public_access/public_method/tvalve_go_straight,
		"valve_toggle" = /datum/public_access/public_method/tvalve_toggle
	)
...
/obj/machinery/atmospherics/tvalve/digital		// can be controlled by AI
	...
	public_variables = list(/datum/public_access/public_variable/tvalve_state)
	public_methods = list(
		/datum/public_access/public_method/tvalve_go_side,
		/datum/public_access/public_method/tvalve_go_straight,
		/datum/public_access/public_method/tvalve_toggle
	)
	stock_part_presets = list(/datum/stock_part_preset/radio/receiver/tvalve = 1)
