...
/datum/public_access/public_variable/power_draw/access_var(obj/machinery/atmospherics/machine)
...
/datum/public_access/public_variable/flow_rate/access_var(obj/machinery/atmospherics/machine)
