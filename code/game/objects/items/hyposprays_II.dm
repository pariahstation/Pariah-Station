...
/obj/item/hypospray/mkii
	...
	icon_state = "hypo2"
	icon = 'icons/obj/hyposprays/hyposprays.dmi'
...
/obj/item/hypospray/mkii/update_overlays()
	...
	if(!small_only)
		...
		vial_spritetype += "-s"
	var/mutable_appearance/chem_loaded = mutable_appearance('icons/obj/hyposprays/hyposprays.dmi', vial_spritetype)
...
/obj/item/hypospray/mkii/afterattack(atom/target, mob/living/user, proximity)
	...
	playsound(loc, long_sound ? 'sound/effects/hypospray/hypospray_long.ogg' : pick('sound/effects/hypospray/hypospray.ogg','sound/effects/hypospray/hypospray2.ogg'), 50, 1, -1)
