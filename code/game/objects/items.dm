...
GLOBAL_DATUM_INIT(welding_sparks, /mutable_appearance, mutable_appearance('code/modules/welding_sparks/icons/welding_effect.dmi', "welding_sparks", GASFIRE_LAYER, ABOVE_LIGHTING_PLANE))
