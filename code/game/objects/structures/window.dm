...
/obj/structure/window/reinforced/shuttle//this is called reinforced because it is reinforced w/titanium
	...
	canSmoothWith = list(SMOOTH_GROUP_SHUTTLE_WALLS, SMOOTH_GROUP_WINDOW_FULLTILE_SHUTTLE, SMOOTH_GROUP_AIRLOCK, SMOOTH_GROUP_SHUTTERS_BLASTDOORS, SMOOTH_GROUP_SHUTTLE_PARTS)
	explosion_block = 3
