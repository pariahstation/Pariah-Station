...
// stairs require /turf/simulated/open/openspace as the tile above them to work, unless your stairs have 'force_open_above' set to TRUE
...
/obj/structure/stairs
	...
	var/force_open_above = FALSE // replaces the turf above this stair obj with /turf/simulated/open/openspace
...
/obj/structure/stairs/proc/build_signal_listener()
	if(listeningTo)
		UnregisterSignal(listeningTo, COMSIG_TURF_MULTIZ_NEW)
	var/turf/simulated/open/openspace/T = get_step_multiz(get_turf(src), UP)
...
/obj/structure/stairs/proc/force_open_above()
	var/turf/simulated/open/openspace/T = get_step_multiz(get_turf(src), UP)
	if(T && !istype(T))
		T.ChangeTurf(/turf/simulated/open/openspace, flags = CHANGETURF_INHERIT_AIR)
