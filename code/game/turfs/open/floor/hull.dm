...
/turf/simulated/open/floor/engine/hull
...
/turf/simulated/open/floor/engine/hull/rcd_act(mob/user, obj/item/construction/rcd/the_rcd, passed_mode) //no rcd destroying this flooring
...
/turf/simulated/open/floor/engine/hull/ceiling
	name = "shuttle ceiling plating"
	var/old_turf_type

/turf/simulated/open/floor/engine/hull/ceiling/AfterChange(flags, oldType)
	. = ..()
	old_turf_type = oldType

/turf/simulated/open/floor/engine/hull/reinforced
