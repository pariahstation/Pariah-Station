 ...
 * unless you want to!
 */
/turf/simulated/open/floor/catwalk_floor	//the base type, meant to look like a maintenance panel
...
/turf/simulated/open/floor/catwalk_floor/Initialize(mapload)
	. = ..()
...
/turf/simulated/open/floor/catwalk_floor/examine(mob/user)
	. = ..()
...
/turf/simulated/open/floor/catwalk_floor/screwdriver_act(mob/living/user, obj/item/tool)
	. = ..()
	covered = !covered
	if(!covered)
...
/turf/simulated/open/floor/catwalk_floor/crowbar_act(mob/user, obj/item/crowbar)
	if(covered)
...
/turf/simulated/open/floor/catwalk_floor/iron
...
/turf/simulated/open/floor/catwalk_floor/iron_white
...
/turf/simulated/open/floor/catwalk_floor/iron_dark
...
/turf/simulated/open/floor/catwalk_floor/flat_white
...
/turf/simulated/open/floor/catwalk_floor/titanium
...
/turf/simulated/open/floor/catwalk_floor/iron_smooth //the original green type
